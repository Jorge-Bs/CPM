...
import uo.cpm.p5.exception.InvalidFieldsException;
...
public class VentanaRegistro extends JDialog {
	...
	private void setMacdonal() {
		this.mac=vPrincipal.mac;
	}
	...
	private JTextField getTxNombre() {
		if (txNombre == null) {
			...
			txNombre.setBounds(220, 26, 120, 22);
	...
	private JPasswordField getPwPass1() {
		if (pwPass1 == null) {
			...
			pwPass1.setBounds(220, 94, 120, 28);
		}
		return pwPass1;
	}
	...
	private JPasswordField getPwPass2() {
		if (pwPass2 == null) {
			...
			pwPass2.setBounds(220, 133, 120, 24);
		}
		return pwPass2;
	}
	...
	private JPanel getPnData() {
		if (pnData == null) {
			...
			pnData.setBounds(60, 11, 362, 168);
