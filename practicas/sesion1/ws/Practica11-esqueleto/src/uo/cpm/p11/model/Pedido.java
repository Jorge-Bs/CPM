...
public class Pedido {
	...
	public List<Articulo> getComida(){
		List<Articulo> comida = new ArrayList<>();
		for(Articulo art:listaPedido) {
			if(!art.getTipo().equals("Bebida")) {
				comida.add(art);
			}
		}
		return comida;
	...
	public List<Articulo> getBebida(){
		List<Articulo> bebida = new ArrayList<>();
		for(Articulo art:listaPedido) {
			if(art.getTipo().equals("Bebida")) {
				bebida.add(art);
			}
